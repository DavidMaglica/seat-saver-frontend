...
class _AccountWidgetState extends State<Account> with TickerProviderStateMixin {
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildAccountDetails('name surname', 'name.surname@email.com'),
  ...
  Widget _buildSettingsItem(IconData icon, String text, String route) {
    return Padding(
  ...
  Widget _buildAccountDetails(String username, String email) {
  ...
  Widget _buildLogOutButton(Function() onPressed) {
    return Align(
